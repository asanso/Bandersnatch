...
f.write('$$x_W = \\text{{\\small{\\tt ')
f.write('0x{},'.format(ZZ(xG_W).hex()))
f.write('}}}$$\n')
f.write('$$y_W = \\text{{\\small{\\tt ')
f.write('0x{}.\n'.format(ZZ(yG_W).hex()))
f.write('}}}$$\n')
f.close()
...
f.write('$$x_M = \\text{{\\small{\\tt ')
f.write('0x{}.'.format(ZZ(xG_M).hex()))
f.write('}}}$$\n')
f.close()
...
f.write('$$x_{TE} = \\text{{\\small{\\tt ')
f.write('0x{},'.format(ZZ(xG_TE).hex()))
f.write('}}}$$\n')
f.write('$$y_{TE} = \\text{{\\small{\\tt ')
f.write('0x{}.\n'.format(ZZ(yG_TE).hex()))
f.write('}}}$$\n')
f.close()
