...
The parameters can be obtained using the script
...
Using the coefficients $u, r_0, r_1, s_0, t_0, t_1$ of the file
\texttt{params-W.py} in our repository, we obtain that
...
twisted Edwards coordinates, where $a_i, b_i, c_i \in \Fp$ are
coefficients available in the file \texttt{params-TE.py} in our repository:
...
model (where $c$ can be found in the file \texttt{params-M.py} in our
repository):
