...
protected by a US patent intil few months ago, but that expired and is
freely usable now).
...
We presente in Section~\ref{sec:bandersnatch} the curve in several
...
$j$-invariant $8000$, meaning that up to an isomorphism, the Vélu's
