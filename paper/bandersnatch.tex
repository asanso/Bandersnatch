...
\begin{abstract}
 ...
 Our banchmark shows that the multiplication is 47\% faster, 
...
in the form of rand one constraint system (R1CS), 
a common approach for writing circuits for zero-knowledge 
...
\begin{table}[h] %\small
  ...
  \begin{tabular}{|l|c|c|}\hline
    ...
    Jubjub & 75 us & \\\hline
    Bandersnatch & 40 us &  \\\hline\hline   
    Improvement & 47\% & \\\hline
  \end{tabular}
...
in~\href{https://github.com/asanso/Bandersnatch/blob/main/code/get\_params.py}{this
  file}.
We give the rational maps defining $\psi$ in three different
